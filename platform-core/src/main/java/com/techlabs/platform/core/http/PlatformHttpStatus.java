package com.techlabs.platform.core.http;

/**
 * 
 * Http Exception 처리  Spring HttpsStatus 값을 동일하게 사용하기 위한 복사본
 * 실제 코드 사용중에는 Spring 패키지에 구현된 HttpsStatus 값을 사용
 *  
 * @author ChungMan_Kim
 * 
 */
public enum PlatformHttpStatus
{
    ...
    private static final PlatformHttpStatus[] VALUES;
    ...
    PlatformHttpStatus(int value, Series series, String reasonPhrase) {
        this.value = value;
        this.series = series;
     ...
     * {@link org.MacrogenHttpStatus.http.HttpStatus.Series#INFORMATIONAL}.
    ...
    /**
     * Whether this status code is in the HTTP series
     * {@link org.MacrogenHttpStatus.http.HttpStatus.Series#SUCCESSFUL}.
     * <p>This is a shortcut for checking the value of {@link #series()}.
     * @since 4.0
     * @see #series()
     */
    ...
    /**
     * Whether this status code is in the HTTP series
     * {@link org.MacrogenHttpStatus.http.HttpStatus.Series#REDIRECTION}.
     * <p>This is a shortcut for checking the value of {@link #series()}.
     * @since 4.0
     * @see #series()
     */
    ...
    /**
     * Whether this status code is in the HTTP series
     * {@link org.MacrogenHttpStatus.http.HttpStatus.Series#CLIENT_ERROR}.
     * <p>This is a shortcut for checking the value of {@link #series()}.
     * @since 4.0
     * @see #series()
     */
    ...
    /**
     * Whether this status code is in the HTTP series
     * {@link org.MacrogenHttpStatus.http.HttpStatus.Series#SERVER_ERROR}.
     * <p>This is a shortcut for checking the value of {@link #series()}.
     * @since 4.0
     * @see #series()
     */
    ...
    /**
     * Whether this status code is in the HTTP series
     * {@link org.MacrogenHttpStatus.http.HttpStatus.Series#CLIENT_ERROR} or
     * {@link org.MacrogenHttpStatus.http.HttpStatus.Series#SERVER_ERROR}.
     * <p>This is a shortcut for checking the value of {@link #series()}.
     * @since 5.0
     ...
     */
    public static PlatformHttpStatus valueOf(int statusCode) {
        PlatformHttpStatus status = resolve(statusCode);
        if (status == null) {
     ...
     */
//    @Nullable
    public static PlatformHttpStatus resolve(int statusCode) {
        // Use cached VALUES instead of values() to prevent array allocation.
        for (PlatformHttpStatus status : VALUES) {
     ...
     * <p>Retrievable via {@link PlatformHttpStatus#series()}.
     */
    public enum Series {
         ...
         * @return the {@code Series} enum constant for the supplied {@code HttpStatus}
         * @deprecated as of 5.3, in favor of invoking {@link PlatformHttpStatus#series()} directly
         */
        @Deprecated
        public static Series valueOf(PlatformHttpStatus status) {

...
import com.techlabs.common.base.http.exception.PlatformRuntimeException;
...
public class RestUtil {
    ...
    public static void setHeaderFileName(HttpServletResponse response, String fileName) {
        ...
        response.setHeader(HttpHeaders.CONTENT_DISPOSITION, "attachment; fileName=\"" +encodFileName  + "\"; charset=UTF-8");
    }
    ...
    public static String encodeFileName(String fileName)
    {
        ...
        {
            throw new PlatformRuntimeException("Encode 실패");
        }
    }
